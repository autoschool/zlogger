package zlogger.integration.controllers;

import base.spring.WebConfig;
...
import zlogger.util.MockConfig;
...
@WebAppConfiguration
@ContextConfiguration(classes = {WebConfig.class, MockConfig.class})
